...
@section('content')
    <form action="{{ route('admin.project-types.update', $projectType) }}" method="POST" class="bg-white p-6 rounded shadow max-w-lg">
        @csrf
        @method('PUT')
        ...
        <p class="text-xs text-gray-400 mt-2">Slug actual: <code>{{ $projectType->slug }}</code></p>

        <div class="mt-4 flex gap-2">
            <button type="submit" class="bg-gray-900 text-white px-4 py-2 rounded hover:bg-gray-700">Actualizar</button>
